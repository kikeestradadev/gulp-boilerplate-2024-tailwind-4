...
var _deleteUnbounceReset = _interopRequireDefault(require("./unbounceFeatures/deleteUnbounceReset"));
var _insertMetaTags = _interopRequireDefault(require("./unbounceFeatures/insertMetaTags"));
var _unbounceCookie = _interopRequireDefault(require("./unbounceFeatures/unbounceCookie"));
...
(function () {
  ...
  (0, _unbounceCookie["default"])();
  _prismjs["default"].highlightAll(); // Corrected: Use Prism.highlightAll() instead of undefined prismjs()
})();

},{"./modules/internalModule":3,"./unbounceFeatures/deleteUnbounceReset":4,"./unbounceFeatures/insertMetaTags":5,"./unbounceFeatures/unbounceCookie":6,"prismjs":1}],3:[function(require,module,exports){
"use strict";
...
var unbounceCookie = function unbounceCookie() {
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (token) {
      var buttonIds = ["topHeader", "joinNowTopheader", "top1", "top2", "top3", "joinNowMidbanner", "joinNowFourWays", "perk1", "perk2", "perk3", "perk4", "perk5", "rewardPromos", "contactUs"];
      buttonIds.forEach(function (id) {
        var element = document.getElementById(id);
        if (element && element.getAttribute("href")) {
          var originalUrl = element.getAttribute("href");
